...
class AdminSellerCommentsController extends ModuleAdminController
{
    ...
    {        
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(  
                array(
                    ...
                    'name' => 'MARKETPLACE_MODERATE_COMMENTS',
                    'required' => false,
                    'is_bool' => true,
                    'class' => 't',
                    'values' => array(
                ...
                array(
                    ...
                    'name' => 'MARKETPLACE_ALLOW_GUEST_COMMENT',
                    'required' => false,
                    'is_bool' => true,
                    'class' => 't',
                    'values' => array(
                ...
                array(
                    ...
                    'name' => 'MARKETPLACE_SEND_COMMENT_SELLER',
                    'required' => false,
                    'is_bool' => true,
                    'class' => 't',
                ...
                array(
                    ...
                    'name' => 'MARKETPLACE_SEND_COMMENT_ADMIN',
                    'required' => false,
                    'is_bool' => true,
                    'class' => 't',
                    'values' => array(
        ...
        $helper->fields_value['MARKETPLACE_MODERATE_COMMENTS'] = Configuration::get('MARKETPLACE_MODERATE_COMMENTS');
        $helper->fields_value['MARKETPLACE_ALLOW_GUEST_COMMENT'] = Configuration::get('MARKETPLACE_ALLOW_GUEST_COMMENT');
        $helper->fields_value['MARKETPLACE_SEND_COMMENT_ADMIN'] = Configuration::get('MARKETPLACE_SEND_COMMENT_ADMIN');
        $helper->fields_value['MARKETPLACE_SEND_COMMENT_SELLER'] = Configuration::get('MARKETPLACE_SEND_COMMENT_SELLER');
    ...
    public function renderModerateLists()
    {
        ...
        if (Configuration::get('MARKETPLACE_MODERATE_COMMENTS'))
        {
    ...
    public function postProcess() {
        if (Tools::isSubmit('submitSellerCommentsSettings')) {
            Configuration::updateValue('MARKETPLACE_MODERATE_COMMENTS', Tools::getValue('MARKETPLACE_MODERATE_COMMENTS'));
            Configuration::updateValue('MARKETPLACE_ALLOW_GUEST_COMMENT', Tools::getValue('MARKETPLACE_ALLOW_GUEST_COMMENT'));
            Configuration::updateValue('MARKETPLACE_SEND_COMMENT_ADMIN', Tools::getValue('MARKETPLACE_SEND_COMMENT_ADMIN'));
            Configuration::updateValue('MARKETPLACE_SEND_COMMENT_SELLER', Tools::getValue('MARKETPLACE_SEND_COMMENT_SELLER'));
        }
        ...
        if (Tools::isSubmit('statusseller_comment'))
        {
            ...
            if ($comment->id)
            {
                ...
                if (Configuration::get('MARKETPLACE_SEND_COMMENT_SELLER') == 1) {
                    ...
                    if ($id_seller_email) {
                        ...
                        $values = array(Configuration::get('PS_SHOP_NAME'),$comment->customer_name, $comment->grade, nl2br($comment->content));
