...
class MarketplaceSellerprofileModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent() {
        ...
        $assets_img_path = __PS_BASE_URI__.'modules/marketplace/views/assets/images/gallery/';
        ...
        if($seller_me)
            ...
            $this->setTemplate('module:marketplace/views/templates/front/sellerprofile.tpl');
        else
            Tools::redirect($this->context->link->getModuleLink('marketplace', 'sellerprofilevisite', array('id_seller' => $id_seller), true));
