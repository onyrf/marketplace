...
class SellerTransport extends ObjectModel
{
    ...
    public static function getCarriersForOrder($id_seller, $id_zone, $groups = null, $cart = null, &$error = array())
    {
        ...
        if (is_array($groups) && !empty($groups)) {
            $result = SellerCarrier::getCarriers($id_lang, true, $id_seller, false, (int)$id_zone, $groups, self::PS_CARRIERS_AND_CARRIER_MODULES_NEED_RANGE);
        } else {
            $result = SellerCarrier::getCarriers($id_lang, true, $id_seller, false, (int)$id_zone, array(Configuration::get('PS_UNIDENTIFIED_GROUP')), self::PS_CARRIERS_AND_CARRIER_MODULES_NEED_RANGE);
        }
        $results_array = array();
